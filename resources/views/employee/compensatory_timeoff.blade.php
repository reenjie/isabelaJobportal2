...
<button class="customaddBtn px-5  py-2" data-bs-toggle="modal" data-bs-target="#newcomp">New Compensatory Time-off <i class="fas fa-plus-circle"></i></button>
@include('components.modal', [
    'id' => 'newcomp',
    'modalsize' => 'modal-lg',
    'modaltitle' => 'New Compensatory Time-off',
    'type' => 'addnewcomp',
])
                        ...
                        <td>
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <br> <br>
                                    <form action="{{route('cancel.Requestct')}}" method="post">
                                        @csrf
