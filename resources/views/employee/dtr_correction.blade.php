@extends('layouts.homeLayout',['pageTitle'=>"DTR Correction","active"=>"dtr_correction"])
...
<button class="customaddBtn px-5  py-2" data-bs-toggle="modal" data-bs-target="#newdtrcorrection">New DTR Correction <i class="fas fa-plus-circle"></i></button>
@include('components.modal', [
    'id' => 'newdtrcorrection',
    'modalsize' => '',
    'modaltitle' => 'New DTR Correction',
    'type' => 'adddtrcorrection',
])
                    ...
                    <td>
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <br> <br>
                                <form action="{{route('cancel.Requestdtr')}}" method="post">
                                    @csrf
