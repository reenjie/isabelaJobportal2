...
<button class="customaddBtn px-5  py-2" data-bs-toggle="modal" data-bs-target="#newmonetization">New Monetization Request <i class="fas fa-plus-circle"></i></button>
        @include('components.modal', [
            'id' => 'newmonetization',
            'modalsize' => '',
            'modaltitle' => 'New Monetization Request',
            'type' => 'newmonetization',
                    ...
                    <td>
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <br> <br>
                                <form action="{{route('cancel.Requestmone')}}" method="post">
                                    @csrf
