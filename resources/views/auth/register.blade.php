    ...
    <div class="card shadow p-2" style="z-index: 1" >
        <div class="card-body">
            ...
            <form action="{{route('register')}}" method="POST">
                ...
                <div class="col-md-4 mb-2">
                    <h6>Middle Name</h6>
                    <input type="text" class="form-control" required name="mname" value="{{old('mname')}}">
                </div>
                <div class="col-md-4 mb-2">
                    <h6>Last Name</h6>
                ...
                <div class="col-md-6 mb-2">
                    <h6>Birth Date</h6>
                    <input type="date" class="form-control" required name="bdate" max="{{date('Y-m-d')}}" value="{{old('bdate')}}">
                </div>
                <div class="col-md-6 mb-2">
                    <h6>Sex</h6>
                   <select name="gender" required class="form-select" id="" value="{{old('gender')}}">
                ...
                <div class="col-md-6 mb-2">
                    <h6>Mobile</h6>
                    <input type="text" required class="form-control" name="mobile" value="{{old('mobile')}}">
                </div>
                ...
                <div class="col-md-6 mb-2">
                    <h6>Password</h6>
                    <input type="password" required class="form-control passv" id="pass" name="password">
        ...
        <h6 style="font-size:10px;text-transform:uppercase"> Your Password should contain the following :</h6>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="password" disabled required class="form-control passv" id="repass" name="repass">
                    <div  id="feedback" >    </div>
                </div>
                <div class="col-md-12">
